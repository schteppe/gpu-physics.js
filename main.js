...
function render() {
  ...
  for(var i=0; i<sphereMeshes.length; i++){
    sphereMeshes[i].material.uniforms.posTex.value = posTextureRead.texture;
  }
  ...
  for(var i=0; i<sphereMeshes.length; i++){
    sphereMeshes[i].material.uniforms.posTex.value = null;
  }
}
